    ...
    return (
        <>
            ...
            <form >
                ...
                <input type="text" id={firstNameId} name={firstNameName} style={{color: firstNameBorderColor, border: `solid 2px ${firstNameBorderColor}`}} /><br/><br/>
                <label htmlFor={lastNameId}>{lastNameLabel}:</label>
                <input type="text" id={lastNameId} name={lastNameName} style={{borderColor: lastNameBorderColor, border: `solid 2px ${lastNameBorderColor}`}} /><br/><br/>
            </form>
        </>
    );
}