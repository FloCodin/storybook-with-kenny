...
export type AlertProps = {
    ...
    textColor: string,
    continueButton?: 'bg-black'|"bg-blue-500"|"bg-green-500"|"bg-red-500"|"bg-orange-500";
        ...
        <>
            <AlertDialog>
                <div className={`border-solid border-gray-500 border-2 flex justify-center bg-${props.triggerColor}`}>
                    <AlertDialogTrigger className={`${props.triggerColor}`}>{AlertContent.triggerText || "Alert"}</AlertDialogTrigger>
                </div>
                <AlertDialogContent className={`${props.alertBackground}`}>
                    <AlertDialogHeader className={`${props.textColor}`} >
                        ...
                        <AlertDialogDescription className={`text-[${props.textColor}]`} >{AlertContent.textDescription }</AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
